...
if __name__ == '__main__':
    ...
    sku_ids = ['100019084146']  # 商品id
    # sku_ids = ['10026477628122', '10026477628123', '10026477628125', '10026477628127', '10026477628129', '10026477628131']
    area = '1_2800_4209'  # 区域id
    asst = Assistant()  # 初始化
    asst.login_by_QRcode()  # 扫码登陆
    for i in sku_ids:
        asst.exec_reserve_seckill_by_time(sku_id=i, buy_time='2021-03-25 18:30:00.000')
